...
class RewardsStructure extends Base<RewardsProps, RewardsState> {
	...
	async componentWillUnmount() {
		const intervalId = this.properties.getIn('recurrent.5s.intervalId') as number;
		if (intervalId) {
									...
									<tr className="border-b border-gray-600">
										<td className="px-4 py-2">
											<div className="flex flex-col">
												...
												<button
													className="mt-2 px-2 py-1 text-sm bg-[#393939] text-[#FE8A00] rounded border border-[#FE8A00] hover:bg-gray-600">
													Trade
												</button>
											</div>
										</td>
